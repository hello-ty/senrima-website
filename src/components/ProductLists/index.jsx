...
export const ProductLists = () => {
  return (
    <div className="bg-white font-fancy lg:px-24 md:px-10 sm:px-1">
      ...
      <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-center text-3xl mb-10">新鮮素材</h2>
      ...
      <div className="max-w-2xl mx-auto pt-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-center text-3xl mb-10">お食事</h2>
      </div>

      <MenuTable title="rice" />
    </div>
  );
};
